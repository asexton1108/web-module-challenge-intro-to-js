...
console.log('task 2', dogYears(45));
...
function annoyingSong(number){
      for(let i = number; i > 0; i --){
        return `${number} bottles of soda on the wall, ${i} bottles of soda, take one down pass it around ${i -1} bottles of soda on the wall`;
      }
}
